...
export class Application extends Adw.Application {
    ...
    constructor() {
        super({
            application_id: 'com.github.confusedalex.timetable',
        ...
        show_about_action.connect('activate', () => {
            const aboutWindow = new Adw.AboutWindow({
                ...
                application_icon: 'com.github.confusedalex.timetable',
                developer_name: 'confusedalex',
                version: '0.1',
                developers: ['confusedalex <alex@confusedserver.de>'],
                copyright: '© 2023 confusedalex',
            });
